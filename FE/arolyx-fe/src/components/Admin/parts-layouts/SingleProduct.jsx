        ...
        <>
            <div className="flex hover:bg-gray-50 bg-white shadow-sm border-r border-b m-0.5 h-14 ">
                ...
                <div className="flex m-1  items-center justify-center w-24 ">
                    <button  onClick={handleEditButtonClickd} className="text-center hover:text-blue-900 text-blue-400 font-semibold text-base"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
