...
export default function FailPopup() {
  ...
  return (
    <>
      ...
      <div className="absolute  end-3 hover:bg-red-400 hover:rounded-full p-1">
      <svg
        ...
        <div className="flex">
          ...
          <h1 className=" ml-2 text-base text-red-950 font-semibold">{formatMessage(popup.text)}</h1>
        </div>
      </div>
    </>
  );
